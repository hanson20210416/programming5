...
if __name__ == "__main__":
    ...
    session = Session()
    try:
        Filepath = '/data/datasets/NCBI/PubMed/pubmed21n1021.xml'
        for i, article_data in enumerate(parse_pubmed_xml(Filepath)):
        ...
        session.close()
##### I do not why if I run my py files, it loaded all articles,
# but If i run sh script by slurm,It just load 200+ articles.
# because of the 'ascii' codec can't encode character.
